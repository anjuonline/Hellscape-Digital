const LugosiAlbumsStatic = () => {
    return (
      <>
        ...
        <div class="gallery_item">
            ...
            <a href="https://open.spotify.com/album/1oJT2KRgPNEf3Nzn0567o4?si=iXfj5ePKQv2kZcGB3IVeMA" target="_blank" rel="noopener noreferrer">
              ...
              <p class="gallery-text">
                <strong>DYING ON THE EAST COAST</strong><br/>
              </p>
            </a>
          </div>
        ...
        <div class="gallery_item">
          ...
          <div class="gallery_item">
            <p class="gallery-tag">Album</p>
            <a href="https://soundcloud.com/lillugosi/sets/lugosi" target="_blank" rel="noopener noreferrer">
  ...
  export default LugosiAlbumsStatic;