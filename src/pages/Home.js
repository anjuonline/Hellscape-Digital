        ...
        <div class="card-container">
            <div class="title-wrap-rainbow">
                ...
                <div class="masonry-wrap">
                    ...
                    <div>
                        <img src="https://f8n-production-collection-assets.imgix.net/0x1f597E08f4e7428845EB693d9F49B33f07eF04eD/1/nft.png?q=80&auto=format%2Ccompress&cs=srgb&max-w=1680&max-h=1680" alt=""/>
                        <p class="masonry-text">
                            CC Plz
                        </p>
                    </div>
                    <div>
                        <img src="https://pbs.twimg.com/media/FRnSLHeXwAMvnoZ?format=jpg&name=4096x4096" alt=""/>
                        <p class="masonry-text">
                            Self Care Night
                        </p>
                    </div>
                    <div>
                        <img src="https://pbs.twimg.com/media/FATYxC0WEAUb4r1?format=jpg&name=large" alt=""/>
                        <p class="masonry-text">
                            Self Care Night
                        </p>
                    </div>
